...
| 모델명 | 파라미터 수 | 장점 | 단점 |
|:---|:---|:---|:---|
| Gemma 2B [1] | 약 2B | - 가볍고 배포가 쉬움<br>- CPU에서도 구동 가능 | - 느린 응답 속도<br>- 다국어 대응력 약함 |
| Llama 2 7B [2] | 약 7B | - 다양한 언어 대응<br>- 비교적 균형 잡힌 성능 | - 높은 하드웨어 요구사항<br>- 상용 라이선스 제한 |
| OpenChat 3.5 [3] | 약 7B | - 영어/중국어에 최적화<br>- 빠른 문맥 이해 및 자연스러운 생성<br>- 4bit 최적화 가능 | - 한국어 최적화 미흡<br>- 일부 문장 자연스러움 부족 |
| Mistral 7B [4] | 약 7B | - 초고속 추론 성능<br>- 메모리 사용 대비 좋은 품질 | - 긴 대화 유지에 다소 약함 |
| GPT-3.5 Turbo [5] | 약 6.7B (추정) | - 뛰어난 대화 품질<br>- 다양한 활용성(API 지원) | - 오픈소스 불가<br>- 직접 배포 불가(클라우드 사용 필요) |
...
[1]: https://huggingface.co/google/gemma-2b
[2]: https://huggingface.co/meta-llama/Llama-2-7b-hf
[3]: https://huggingface.co/openchat/openchat-3.5-1210
